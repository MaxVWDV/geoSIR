...
inputs.Name = 'V4_1';      %Name to save this run parameters under
...
inputs.ND_case = 4;                                                   %ND case. See run file for details.

inputs.ND_time = 25;                                                  %Timing of ND after run start.
